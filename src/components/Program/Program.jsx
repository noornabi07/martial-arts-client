...
const Program = () => {
    return (
        <div className='grid lg:grid-cols-3 gap-5 items-center'>
            <div data-aos="fade-right" data-aos-duration="1500" className='text-center md:text-left'>
            ...
            <div>
                <img data-aos="fade-up" data-aos-duration="1500" className='md:h-[450px] rounded-md px-3' src={program1} alt="" />
            </div>
            <div>
                <img data-aos="fade-down" data-aos-duration="1500"  className='md:h-[450px] rounded-md px-3' src={program2} alt="" />
            </div>
        </div>
    );
};
